...
chkForceInherited.Value = false;   % <<< NEW: reset to default off
...
try
    valReport = validateModelCompatibility(folder, models, ...
        ...
        struct('ForceInheritedSampleTimes', logical(chkForceInherited.Value)));
catch valErr
...
options = struct( ...
    ...
    'ForceInheritedSampleTimes', logical(chkForceInherited.Value), ... % <<< PASSED
